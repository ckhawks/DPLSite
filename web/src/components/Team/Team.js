    ...
    <>
      <div className="bg-white border rounded-lg overflow-hidden">
        <header className="bg-gray-300 text-gray-700 py-3 px-4">
          <h2 className="text-sm font-semibold">Team {team.id} Detail</h2>
        </header>
        <table className="w-full text-sm">
          <tbody>
            <tr className="odd:bg-gray-100 even:bg-white border-t">
              ...
              <td className="p-3">{team.createdAt}</td>
            </tr><tr className="odd:bg-gray-100 even:bg-white border-t">
              ...
              <td className="font-semibold p-3 text-right md:w-1/5">logoUrl</td>
              <td className="p-3">{team.logoUrl}</td>
            </tr>
          </tbody>
        </table>
      </div>
