      ...
      <table className="table-auto w-full min-w-3xl text-sm">
        <thead>
          <tr className="bg-gray-300 text-gray-700">
            ...
            <th className="font-semibold text-left p-3">bio</th>
            <th className="font-semibold text-left p-3">team</th>
        ...
        <tbody>
          {users.map((user) => (
            ...
            >
              ...
              <td className="p-3">{truncate(user.bio)}</td>
              <td className="p-3">{truncate(user.team?.name)}({user.team?.id})</td>
